  ...
  <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="10000">
        <img src="https://product.hstatic.net/1000288177/product/upload_a80231319ea94692a5ac7e23f6152aad_master.jpg" style="height:600px" class="d-block w-100" alt="No photos found">
      </div>
      <div class="carousel-item" data-bs-interval="2000">
        <img src="https://d1a9v60rjx2a4v.cloudfront.net/2018/01/21/17_29_29_480_optimus_prime_3d_model_c4d_max_obj_fbx_ma_lwo_3ds_3dm_stl_1878173_o_1.jpg" style="height:600px" class="d-block w-100" alt="No photos found">
      </div>
      <div class="carousel-item">
        <img src="http://mohinhdep.net/wp-content/uploads/2018/10/batman-mohinhdep.net-5-2.jpg" class="d-block w-100" alt="No photos found" style="height:600px">
      </div>
    </div>
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4">
          ...
          while ($row = mysqli_fetch_array($result)) {
            ...
            <div class='card border-success' >
                       <div class='card-header' style='background-color: rgb(0 0 0 / 8%);'>".$row['productName']."</div>
                        <div class='card-body'>
                            <p class='card-text'><img src='".$row['productImg']."' class = 'img-fluid rounded' style = 'height:13rem; width:100%' /></p>
                        </div>
                        <div class='card-footer' style='background-color: rgb(0 0 0 / 8%);'>
                        <a class='btn btn-warning' href='detail.php?id=".$row['productId']."'>Detail</a>
                        <a class='btn btn-primary' href='cart.php?id=".$row['productId']."'>Add to Cart</a>
                        </div>
                        </div>
                        </div>
                        ";
